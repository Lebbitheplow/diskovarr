...
export default function AppShell({ children }) {
  ...
  return (
    <div className="app-shell" data-rail={collapsed ? 'collapsed' : 'expanded'}>
      ...
      {/* Mobile: FAB opens the rail as a drawer. It carries every destination
          the old FAB popup listed, so nothing became unreachable. */}
      <button
      ...
      >
        <Avatar user={user} className="nav-fab-avatar" />
      </button>
        ...
        <div className="info-modal-backdrop open" onClick={() => setInfoOpen(false)}>
          <div className="info-modal-card" role="dialog" aria-modal="true" onClick={e => e.stopPropagation()}>
            ...
            <div className="info-modal-logo">
              ...
              <button className="info-modal-version" onClick={() => { setInfoOpen(false); setChangelogOpen(true) }}>v{import.meta.env.VITE_APP_VERSION || '2.7.0'}</button>
            </div>
