...
- Node.js 23.4+ (required for the built-in SQLite module)
...
# Edit server/.env and fill in your Plex credentials (see Environment Variables below)
...
```
dist/          # Built React frontend (generated by npm run build, served by Express)
