 ...
 * so this needs no native build step (mirrors the hand-rolled image work in
 * discordAvatar.js, but with real text layout).
 *
...
async function renderPng(cardData, variant = 'og') {
  ...
  // Rasterize at 2× the logical size so text stays crisp after platforms downscale.
