...
// instead of literal **/*/__/== characters.
//
// Source markers (set by BroadcastMessage.jsx toolbar): **bold**, *italic*, __underline__, ==highlight==.
...
const forDiscord  = (text) => transformForChannel(text, { bold: true, italic: true, underline: true });
...
const forGotify   = (text) => transformForChannel(text, { bold: true, italic: true });
